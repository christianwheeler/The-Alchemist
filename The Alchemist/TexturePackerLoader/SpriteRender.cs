namespace TexturePackerLoader
{
    ...
    public class SpriteRender
    {
        ...
        public void Draw(SpriteFrame sprite, Vector2 position, Color? color = null, float rotation = 0, float scale = 0.05f, SpriteEffects spriteEffects = SpriteEffects.None)
        {
